    ...
    <section id="about" className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-5 relative">
          <div className="bg-white dark:bg-slate-800/90 p-4 rounded-3xl shadow-sm border border-sky-100 dark:border-slate-700 relative z-10">
            <div className="bg-gradient-to-br from-sky-900 via-emerald-950 to-sky-950 text-white rounded-2xl p-8 sm:p-10 text-center shadow-inner">
              <div className="w-16 h-16 mx-auto mb-4 bg-white/10 border border-white/20 rounded-2xl shadow-sm flex items-center justify-center text-amber-300 text-3xl">
              ...
              <div className="mt-6 pt-6 border-t border-sky-800/80 flex items-center justify-center gap-6 text-left">
                <div>
                  <div className="text-lg font-extrabold text-amber-300 font-mono">15630</div>
                  <div className="text-[10px] text-sky-200">
                    {lang === 'en' ? 'Govt Licence' : 'সরকারি লাইসেন্স'}
                  </div>
                </div>
                <div className="h-8 w-px bg-sky-800"></div>
                <div>
                  <div className="text-lg font-extrabold text-emerald-300 font-mono">100%</div>
                  <div className="text-[10px] text-sky-200">
          ...
          <div className="absolute -bottom-5 -right-2 sm:-right-4 bg-white dark:bg-slate-900 rounded-2xl p-4 shadow-lg border border-emerald-100 dark:border-slate-700 flex items-center gap-3 z-20">
            <div className="w-11 h-11 rounded-xl bg-sky-600 text-white font-extrabold text-lg flex items-center justify-center shadow-sm font-mono">
              11+
            </div>
        ...
        <div className="lg:col-span-7">
          <span className="inline-flex items-center gap-1.5 bg-sky-50 dark:bg-sky-950/60 text-sky-700 dark:text-sky-300 border border-sky-200/80 dark:border-sky-800 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider mb-4">
            <Shield className="w-3.5 h-3.5 text-sky-600" />
            {lang === 'en' ? 'About MASK Hajj Group' : 'মাস্ক হজ গ্রুপ পরিচিতি'}
          </span>
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-800 dark:text-white tracking-tight leading-tight mb-6">
            {lang === 'en'
