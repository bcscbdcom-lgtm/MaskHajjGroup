...
export const BlogSection: React.FC<BlogSectionProps> = ({ lang }) => {
  ...
  return (
    <section id="blog" className="py-20 bg-slate-50/70 dark:bg-slate-900/60 border-t border-slate-200/60 dark:border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-12 gap-4">
          ...
          <button
            ...
            className="text-xs font-bold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700 hover:border-blue-500 dark:hover:border-blue-400 px-4 py-2.5 rounded-xl transition flex items-center gap-1.5 shadow-xs cursor-pointer"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {blogArticlesData.map((article) => (
            <div
              ...
              className="bg-white dark:bg-slate-800/90 rounded-3xl overflow-hidden border border-slate-200/80 dark:border-slate-700 soft-shadow hover:-translate-y-1.5 hover:border-blue-300 dark:hover:border-blue-500 transition duration-300 flex flex-col justify-between cursor-pointer group"
            >
              <div>
                {/* Visual Header Box */}
                <div className="h-44 bg-gradient-to-tr from-slate-950 via-slate-900 to-slate-800 relative flex items-center justify-center text-white overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <h3 className="font-bold text-slate-900 dark:text-white text-base leading-snug group-hover:text-blue-700 dark:group-hover:text-blue-400 transition-colors">
              ...
              <div className="p-6 pt-0">
                <div className="text-xs font-bold text-blue-600 dark:text-blue-400 group-hover:text-blue-700 dark:group-hover:text-blue-300 flex items-center gap-1">
